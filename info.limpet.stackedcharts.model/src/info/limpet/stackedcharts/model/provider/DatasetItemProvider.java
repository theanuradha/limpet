...
/**
 * This is the item provider adapter for a {@link info.limpet.stackedcharts.model.Dataset} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    IItemPropertySource
{
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         StackedchartsPackage.Literals.DATASET__NAME,
         true,
         false,
         false,
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
    if (childrenFeatures == null)
    {
      ...
      childrenFeatures.add(StackedchartsPackage.Literals.DATASET__MEASUREMENTS);
      childrenFeatures.add(StackedchartsPackage.Literals.DATASET__STYLING);
    }
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
  {
    ...
    newChildDescriptors.add
      (createChildParameter
        (StackedchartsPackage.Literals.DATASET__MEASUREMENTS,
         StackedchartsFactory.eINSTANCE.createDataItem()));

    newChildDescriptors.add
      (createChildParameter
        (StackedchartsPackage.Literals.DATASET__STYLING,
         StackedchartsFactory.eINSTANCE.createStyling()));

    newChildDescriptors.add
      (createChildParameter
        (StackedchartsPackage.Literals.DATASET__STYLING,
         StackedchartsFactory.eINSTANCE.createPlainStyling()));

    newChildDescriptors.add
      (createChildParameter
        (StackedchartsPackage.Literals.DATASET__STYLING,
         StackedchartsFactory.eINSTANCE.createLinearStyling()));
  }
