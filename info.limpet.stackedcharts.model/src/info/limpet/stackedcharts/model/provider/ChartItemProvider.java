...
/**
 * This is the item provider adapter for a {@link info.limpet.stackedcharts.model.Chart} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    IItemPropertySource
{
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         StackedchartsPackage.Literals.CHART__NAME,
         true,
         false,
         false,
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         StackedchartsPackage.Literals.CHART__TITLE,
         true,
         false,
         false,
         ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
    if (childrenFeatures == null)
    {
      ...
      childrenFeatures.add(StackedchartsPackage.Literals.CHART__MAX_AXES);
      childrenFeatures.add(StackedchartsPackage.Literals.CHART__MIN_AXES);
    }
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
  {
    ...
    newChildDescriptors.add
      (createChildParameter
        (StackedchartsPackage.Literals.CHART__MAX_AXES,
         StackedchartsFactory.eINSTANCE.createDependentAxis()));

    newChildDescriptors.add
      (createChildParameter
        (StackedchartsPackage.Literals.CHART__MIN_AXES,
         StackedchartsFactory.eINSTANCE.createDependentAxis()));
  }
  ...
  public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection)
  {
    ...
    boolean qualify =
      childFeature == StackedchartsPackage.Literals.CHART__MAX_AXES ||
      childFeature == StackedchartsPackage.Literals.CHART__MIN_AXES;
